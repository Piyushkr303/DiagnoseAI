...
def healthcare_planner(symptoms, medical_history, current_medications, lab_report_content="", history=""):
    ...
    print(f"Lab Report Summary: {lab_summary}")

    # Step 2: Generate Diagnosis
    diagnosis = diagnosis_chain.run(symptoms=symptoms, history=new_history, lab_report=lab_summary)
    new_history = update_history(new_history, f"Diagnosis: {diagnosis}")
    print(f"Diagnosis: {diagnosis}")

    # Step 3: Generate Treatments
